...
- Theme trajectory charts
- Global correlation engine
- Risk deduction engine
...
### APIs & Tools
- Groq AI (llama-3.1-8b-instant) — AI briefings and analysis
- Twelve Data API — market chart data
- rss2json — live financial news feeds (Reuters, MarketWatch, Bloomberg)

### AI Tools Used in Development
- Claude (Anthropic) — primary development assistant
- Replit AI — development environment assistance
